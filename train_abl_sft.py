...
os.environ["CUDA_VISIBLE_DEVICES"]="6,7,0,5,4,2,3,1"
if not os.path.exists('model_abl_sft_run4'):
    os.mkdir('model_abl_sft_run4')
log_path = os.path.join('model_abl_sft_run4', str(datetime.datetime.now()) + '.txt')
mode='train_data3'
...
for epoch in range(opt.epoch, opt.n_epochs):
    ...
    if epoch>84:
        torch.save(vpnet.state_dict(), ('model_abl_sft_run4/vpnet_%d.pth' % (epoch + 1)))
        torch.save(sdnet.state_dict(), ('model_abl_sft_run4/sdnet_%d.pth' % (epoch + 1)))
