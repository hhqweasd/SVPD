...
if not os.path.exists('model_detection_sft_is_data3_sd'):
    os.mkdir('model_detection_sft_is_data3_sd')
log_path = os.path.join('model_detection_sft_is_data3_sd', str(datetime.datetime.now()) + '.txt')
mode='train'
...
for epoch in range(opt.epoch, opt.n_epochs):
    ...
    if epoch>84:
        torch.save(sdnet.state_dict(), ('model_detection_sft_is_data3_sd/sdnet_%d.pth' % (epoch + 1)))
