...
from model_vp_conic_anchor_test import VanishingNet
...
os.environ["CUDA_VISIBLE_DEVICES"]="1,2,5,7,3,4,6,0"
...
parser.add_argument('--generator_1', type=str, default='model_vp_conic_ori_anchor/vpnet_best.pth', help='A2B generator checkpoint file')
...
err = np.array(err)
np.savez('./model_vp_conic_ori_anchor/angle_best.npz', err=err)
scipyio.savemat('model_vp_conic_ori_anchor/err_best.mat', {'name': err})
errdist = np.array(errdist)
np.savez('./model_vp_conic_ori_anchor/dist_best.npz', errdist=errdist)
scipyio.savemat('model_vp_conic_ori_anchor/dist_best.mat', {'name': errdist})
scipyio.savemat('model_vp_conic_ori_anchor/imgname_best.mat', {'name': imgname})
