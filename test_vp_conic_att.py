...
from model_vp_conic_att_test import VanishingNet
...
os.environ["CUDA_VISIBLE_DEVICES"]="2,3,0,7,5,6,4,1"
...
parser.add_argument('--generator_1', type=str, default='model_vp_conic_att/vpnet_100.pth', help='A2B generator checkpoint file')
...
err = np.array(err)
np.savez('./model_vp_conic_att/angle_100.npz', err=err)
scipyio.savemat('model_vp_conic_att/err_100.mat', {'name': err})
errdist = np.array(errdist)
np.savez('./model_vp_conic_att/dist_100.npz', errdist=errdist)
scipyio.savemat('model_vp_conic_att/dist_100.mat', {'name': errdist})
scipyio.savemat('model_vp_conic_att/imgname_100.mat', {'name': imgname})
