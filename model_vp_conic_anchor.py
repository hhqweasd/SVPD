...
from conic_anchor import ConicConv
...
class ApolloniusNet(nn.Module):
    def __init__(self, output_stride, upsample_scale):
        ...
        self.conv1 = ConicConv(32, 64,(3,7))
        self.bn2 = nn.BatchNorm2d(64)
        self.conv2 = ConicConv(64, 128,(3,7))
        self.bn3 = nn.BatchNorm2d(128)
        self.conv3 = ConicConv(128, 256,(3,7))
        self.bn4 = nn.BatchNorm2d(256)
        self.conv4 = ConicConv(256, 256,(3,7))
