...
if not os.path.exists('model_vp_conic_anchors_ca_ab'):
    os.mkdir('model_vp_conic_anchors_ca_ab')
opt.log_path = os.path.join('model_vp_conic_anchors_ca_ab', str(datetime.datetime.now()) + '.txt')
...
for epoch in range(opt.epoch, opt.n_epochs):
    ...
    if epoch>89:
        torch.save(vpnet.state_dict(), ('model_vp_conic_anchors_ca_ab/vpnet_%d.pth' % (epoch + 1)))
    ...
    if epoch>90:
        with torch.no_grad(): 
            ...
            if mean_loss < best_mean_loss:
                ...
                torch.save(vpnet.state_dict(), ('model_vp_conic_anchors_ca_ab/vpnet_best.pth'))
