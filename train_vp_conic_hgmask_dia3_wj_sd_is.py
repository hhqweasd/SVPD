...
from model_vp_conic_hgmask_dia3_256 import VanishingNet
from datasets_vp_full_is_256 import ImageDataset

os.environ["CUDA_VISIBLE_DEVICES"]="6,7,5,2,1,4,0,3"
...
if not os.path.exists('model_vp_conic_hgmask_dia3_wj_sd_is_vp3001'):
    os.mkdir('model_vp_conic_hgmask_dia3_wj_sd_is_vp3001')
opt.log_path = os.path.join('model_vp_conic_hgmask_dia3_wj_sd_is_vp3001', str(datetime.datetime.now()) + '.txt')
...
for epoch in range(opt.epoch, opt.n_epochs):
    for i, (real_nsr,mask,realco) in enumerate(dataloader):
        ...
        loss_sd = loss_fuse + loss1_h2l + loss2_h2l + loss3_h2l + loss4_h2l + loss1_l2h + \
    ...
    if epoch>89:
        torch.save(vpnet.state_dict(), ('model_vp_conic_hgmask_dia3_wj_sd_is_vp3001/vpnet_%d.pth' % (epoch + 1)))
        torch.save(sdnet.state_dict(), ('model_vp_conic_hgmask_dia3_wj_sd_is_vp3001/sdnet_%d.pth' % (epoch + 1)))
