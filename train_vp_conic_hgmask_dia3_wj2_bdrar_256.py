...
from datasets_vp_full_bdrar_256 import ImageDataset

os.environ["CUDA_VISIBLE_DEVICES"]="6,7,3,4,5,0,2,1"
...
if not os.path.exists('model_vp_conic_hgmask_dia3_wj2_bdrar_256'):
    os.mkdir('model_vp_conic_hgmask_dia3_wj2_bdrar_256')
opt.log_path = os.path.join('model_vp_conic_hgmask_dia3_wj2_bdrar_256', str(datetime.datetime.now()) + '.txt')
...
for epoch in range(opt.epoch, opt.n_epochs):
    ...
    if epoch>89:
        torch.save(vpnet.state_dict(), ('model_vp_conic_hgmask_dia3_wj2_bdrar_256/vpnet_%d.pth' % (epoch + 1)))
