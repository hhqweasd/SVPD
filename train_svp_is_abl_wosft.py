...
if not os.path.exists('model_svp_is_abl_wosft_run1'):
    os.mkdir('model_svp_is_abl_wosft_run1')
log_path = os.path.join('model_svp_is_abl_wosft_run1', str(datetime.datetime.now()) + '.txt')
mode='train_data3'
...
for epoch in range(opt.epoch, opt.n_epochs):
    ...
    if (epoch+1)>=70:
        torch.save(vpnet.state_dict(), ('model_svp_is_abl_wosft_run1/vpnet_%d.pth' % (epoch + 1)))
        torch.save(sdnet.state_dict(), ('model_svp_is_abl_wosft_run1/sdnet_%d.pth' % (epoch + 1)))
