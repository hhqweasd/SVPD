...
if not os.path.exists('model_vpnet_data3_run1'):
    os.mkdir('model_vpnet_data3_run1')
log_path = os.path.join('model_vpnet_data3_run1', str(datetime.datetime.now()) + '.txt')
mode='train_data3'
...
for epoch in range(opt.epoch, opt.n_epochs):
    ...
    if epoch>(opt.n_epochs-11):
        torch.save(vpnet.state_dict(), ('model_vpnet_data3_run1/vpnet_%d.pth' % (epoch + 1)))
