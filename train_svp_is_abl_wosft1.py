...
from hourglass_pose_abl_wosft1  import hg
...
# os.environ["CUDA_VISIBLE_DEVICES"]="5,6,0,1,7,4,2,3"
# os.environ["CUDA_VISIBLE_DEVICES"]="2,4,0,1,5,6,7,3"
if not os.path.exists('model_svp_is_abl_wosft1_run2'):
    os.mkdir('model_svp_is_abl_wosft1_run2')
log_path = os.path.join('model_svp_is_abl_wosft1_run2', str(datetime.datetime.now()) + '.txt')
mode='train_data3'
...
for epoch in range(opt.epoch, opt.n_epochs):
    ...
    if (epoch+1)>=70:
        torch.save(vpnet.state_dict(), ('model_svp_is_abl_wosft1_run2/vpnet_%d.pth' % (epoch + 1)))
        torch.save(sdnet.state_dict(), ('model_svp_is_abl_wosft1_run2/sdnet_%d.pth' % (epoch + 1)))
