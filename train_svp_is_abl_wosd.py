...
if not os.path.exists('model_svp_is_abl_wosd_run4'):
    os.mkdir('model_svp_is_abl_wosd_run4')
log_path = os.path.join('model_svp_is_abl_wosd_run4', str(datetime.datetime.now()) + '.txt')
mode='train_data3'
...
for epoch in range(opt.epoch, opt.n_epochs):
    ...
    if (epoch+1)>=70:
        torch.save(vpnet.state_dict(), ('model_svp_is_abl_wosd_run4/vpnet_%d.pth' % (epoch + 1)))
