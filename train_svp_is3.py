...
from hourglass_pose_mask_wj2_newsft3  import hg
...
if not os.path.exists('model_svp_is3_run4'):
    os.mkdir('model_svp_is3_run4')
log_path = os.path.join('model_svp_is3_run4', str(datetime.datetime.now()) + '.txt')
mode='train_data3'
...
for epoch in range(opt.epoch, opt.n_epochs):
    ...
    if (epoch+1)>=70:
        torch.save(vpnet.state_dict(), ('model_svp_is3_run4/vpnet_%d.pth' % (epoch + 1)))
        torch.save(sdnet.state_dict(), ('model_svp_is3_run4/sdnet_%d.pth' % (epoch + 1)))
