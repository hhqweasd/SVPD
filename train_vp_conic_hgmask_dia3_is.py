...
os.environ["CUDA_VISIBLE_DEVICES"]="5,6,3,4,2,0,1,7"
...
if not os.path.exists('model_vp_conic_hgmask_dia3_is'):
    os.mkdir('model_vp_conic_hgmask_dia3_is')
opt.log_path = os.path.join('model_vp_conic_hgmask_dia3_is', str(datetime.datetime.now()) + '.txt')
...
for epoch in range(opt.epoch, opt.n_epochs):
    ...
    if epoch>89:
        torch.save(vpnet.state_dict(), ('model_vp_conic_hgmask_dia3_is/vpnet_%d.pth' % (epoch + 1)))
