...
from hourglass_pose_mask_wj2_newsft2_1  import hg
...
# os.environ["CUDA_VISIBLE_DEVICES"]="2,3,0,5,6,7,4,1"
# os.environ["CUDA_VISIBLE_DEVICES"]="4,5,0,3,6,7,2,1"
os.environ["CUDA_VISIBLE_DEVICES"]="6,7,0,3,4,5,2,1"

if not os.path.exists('model_abl_sft2_1_run3'):
    os.mkdir('model_abl_sft2_1_run3')
log_path = os.path.join('model_abl_sft2_1_run3', str(datetime.datetime.now()) + '.txt')
mode='train_data3'
...
for epoch in range(opt.epoch, opt.n_epochs):
    ...
    if epoch < 75 and epoch % 5 == 0:
        torch.save(vpnet.state_dict(), ('model_abl_sft2_1_run3/vpnet_%d.pth' % (epoch + 1)))
        torch.save(sdnet.state_dict(), ('model_abl_sft2_1_run3/sdnet_%d.pth' % (epoch + 1)))
