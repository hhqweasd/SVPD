...
from model_vp_conic_anchors_test import VanishingNet
...
os.environ["CUDA_VISIBLE_DEVICES"]="3,7,5,1,2,4,6,0"
...
parser.add_argument('--generator_1', type=str, default='model_vp_conic_ori_anchors/vpnet_100.pth', help='A2B generator checkpoint file')
...
err = np.array(err)
np.savez('./model_vp_conic_ori_anchors/angle_100.npz', err=err)
scipyio.savemat('model_vp_conic_ori_anchors/err_100.mat', {'name': err})
errdist = np.array(errdist)
np.savez('./model_vp_conic_ori_anchors/dist_100.npz', errdist=errdist)
scipyio.savemat('model_vp_conic_ori_anchors/dist_100.mat', {'name': errdist})
scipyio.savemat('model_vp_conic_ori_anchors/imgname_100.mat', {'name': imgname})
