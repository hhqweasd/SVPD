...
if not os.path.exists('model_svp_run2_1'):
    os.mkdir('model_svp_run2_1')
log_path = os.path.join('model_svp_run2_1', str(datetime.datetime.now()) + '.txt')
mode='train_data3'
...
for epoch in range(opt.epoch, opt.n_epochs):
    ...
    if epoch>74:
        torch.save(vpnet.state_dict(), ('model_svp_run2_1/vpnet_%d.pth' % (epoch + 1)))
        torch.save(sdnet.state_dict(), ('model_svp_run2_1/sdnet_%d.pth' % (epoch + 1)))
