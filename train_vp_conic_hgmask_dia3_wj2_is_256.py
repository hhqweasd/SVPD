...
os.environ["CUDA_VISIBLE_DEVICES"]="3,4,5,6,7,0,2,1"
...
if not os.path.exists('model_vp_conic_hgmask_dia3_wj2_is_256'):
    os.mkdir('model_vp_conic_hgmask_dia3_wj2_is_256')
opt.log_path = os.path.join('model_vp_conic_hgmask_dia3_wj2_is_256', str(datetime.datetime.now()) + '.txt')
...
for epoch in range(opt.epoch, opt.n_epochs):
    ...
    if epoch>89:
        torch.save(vpnet.state_dict(), ('model_vp_conic_hgmask_dia3_wj2_is_256/vpnet_%d.pth' % (epoch + 1)))
