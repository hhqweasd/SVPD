...
os.environ["CUDA_VISIBLE_DEVICES"]="4,7,5,6,3,0,2,1"
...
if not os.path.exists('model_vp_conic_hgmask_dia3_wj2_is'):
    os.mkdir('model_vp_conic_hgmask_dia3_wj2_is')
opt.log_path = os.path.join('model_vp_conic_hgmask_dia3_wj2_is', str(datetime.datetime.now()) + '.txt')
...
for epoch in range(opt.epoch, opt.n_epochs):
    ...
    if epoch>89:
        torch.save(vpnet.state_dict(), ('model_vp_conic_hgmask_dia3_wj2_is/vpnet_%d.pth' % (epoch + 1)))
