...
from model_vp_conic_anchors_ca_mask_256 import VanishingNet
from datasets_vp_full_256 import ImageDataset
...
if not os.path.exists('model_vp_conic_anchors_ca_mask_256'):
    os.mkdir('model_vp_conic_anchors_ca_mask_256')
opt.log_path = os.path.join('model_vp_conic_anchors_ca_mask_256', str(datetime.datetime.now()) + '.txt')
...
for epoch in range(opt.epoch, opt.n_epochs):
    ...
    # torch.save(vpnet.state_dict(), 'model_vp_conic_anchors_ca_mask_256/vpnet.pth')

    if epoch>89:
        torch.save(vpnet.state_dict(), ('model_vp_conic_anchors_ca_mask_256/vpnet_%d.pth' % (epoch + 1)))
    ...
    if epoch>90:
        with torch.no_grad(): 
            ...
            if mean_loss < best_mean_loss:
                ...
                torch.save(vpnet.state_dict(), ('model_vp_conic_anchors_ca_mask_256/vpnet_best.pth'))
