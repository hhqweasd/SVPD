...
from model_vp_conic_anchors_ca import VanishingNet
...
if not os.path.exists('model_vp_conic_ori_anchors_ca'):
    os.mkdir('model_vp_conic_ori_anchors_ca')
opt.log_path = os.path.join('model_vp_conic_ori_anchors_ca', str(datetime.datetime.now()) + '.txt')
...
for epoch in range(opt.epoch, opt.n_epochs):
    ...
    if epoch>89:
        torch.save(vpnet.state_dict(), ('model_vp_conic_ori_anchors_ca/vpnet_%d.pth' % (epoch + 1)))
